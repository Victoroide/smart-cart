        ...
        with transaction.atomic():
            try:
                ...
                LoggerService.objects.create(
                    ...
                    action='CREATE',
                    table_name='Payment',
                    description='Created payment ' + str(response.data.get('id'))
                )
                return response
            except Exception as e:
                LoggerService.objects.create(
                    ...
                    action='ERROR',
                    table_name='Payment',
                    description='Error on create payment: ' + str(e)
                )
                raise e
        ...
        with transaction.atomic():
            try:
                ...
                LoggerService.objects.create(
                    ...
                    action='PATCH',
                    table_name='Payment',
                    description='Partially updated payment ' + str(response.data.get('id'))
                )
                return response
            except Exception as e:
                LoggerService.objects.create(
                    ...
                    action='ERROR',
                    table_name='Payment',
                    description='Error on partial_update payment: ' + str(e)
                )
                raise e
        ...
        with transaction.atomic():
            try:
                ...
                LoggerService.objects.create(
                    ...
                    action='DELETE',
                    table_name='Payment',
                    description='Deleted payment ' + str(instance.id)
                )
                return Response(status=status.HTTP_204_NO_CONTENT)
            except Exception as e:
                LoggerService.objects.create(
                    ...
                    action='ERROR',
                    table_name='Payment',
                    description='Error on delete payment: ' + str(e)
                )
                raise e
